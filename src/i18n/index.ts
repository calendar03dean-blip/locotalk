...
export const translations = {
  ko: {
    ...
    login_back: '뒤로',
    // 진입 환영·안심 헤더 (가치 먼저)
    entry_welcome_title: '반가워요! 동네 이웃과 익명으로 연결돼요',
    entry_welcome_sub: '딱 한 번 본인인증이면 시작이에요. 안전하게 모셔드릴게요 😊',
    entry_steps: '본인인증 → 관심사 선택 → 바로 시작',
    // 약관 3종 동의 (진입 게이트)
    consent_all: '약관에 모두 동의할게요',
    consent_all_hint: '모두 안전한 이용을 위한 필수 약관이에요',
    consent_required: '[필수]',
    consent_privacy: '개인정보처리방침',
    consent_service: '서비스 이용약관',
    consent_location: '위치기반서비스 이용약관',
    consent_view: '내용 보기',
    consent_need: '약관에 동의하면 본인인증을 시작할 수 있어요 👇',
    consent_ready: '이제 시작할 수 있어요!',
    ...
    auth_signup_cta: '동의하고 본인인증 시작하기',
    auth_login_cta: '로그인',
    ...
    locperm_intro_extra: '거의 다 왔어요 · 마지막 단계예요',
  ...
  en: {
    ...
    // Entry welcome / reassurance header (value first)
    entry_welcome_title: 'Welcome! Connect anonymously with neighbors',
    entry_welcome_sub: 'Just one quick identity check and you’re in. We’ll keep you safe 😊',
    entry_steps: 'Verify → Pick interests → Start',
    // Terms consent (entry gate)
    consent_all: 'I agree to all terms',
    consent_all_hint: 'These are required terms for safe use',
    ...
    consent_view: 'View details',
    consent_need: 'Agree to the terms to start identity check 👇',
    consent_ready: 'You’re all set to start!',
    login_back: 'Back',
    ...
    auth_signup_cta: 'Agree & start identity check',
    ...
    locperm_intro_extra: 'Almost there · last step',
